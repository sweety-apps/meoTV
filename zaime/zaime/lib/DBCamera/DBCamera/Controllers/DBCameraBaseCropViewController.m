...
- (void) reset:(BOOL)animated
{
    ...
    CGRect frame = self.initialImageFrame;
    frame.origin.y = ([[UIScreen mainScreen] bounds].size.height-[[UIScreen mainScreen] bounds].size.width)/2.f;
    self.initialImageFrame = frame;
