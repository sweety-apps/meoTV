...
// SQAESDE
#define COCOAPODS_POD_AVAILABLE_SQAESDE
#define COCOAPODS_VERSION_MAJOR_SQAESDE 0
#define COCOAPODS_VERSION_MINOR_SQAESDE 1
#define COCOAPODS_VERSION_PATCH_SQAESDE 1
